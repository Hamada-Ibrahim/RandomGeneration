		      ...
		      for (int numser = 1; numser <= 1; numser++)
		         {
		    	  ...
		    	  try 
	    	        {
		    		  JsonWriter jsonWriter = null;
		    		 File sigRule = new File("/mnt/Work/PhD/New PhD/Time/service400"+numser+".json");
	        	     //File sigRule = new File("/mnt/C486149D861491D2/PhD/New PhD/0000 Meetings/RVE_MS04/RVE/Services/service"+numser+".json"); 
			    	 ...
			    	 total += numrules; 
	        		 for (int rule=1; rule<=400; rule++)//numrules; rule++) 
		                {
	      			    	 ...
	      			    	 if (ss.equals("Max"))
		      			       {
	      			    	    ...
	      			    	    //while (Istr.contains(n))
    			    	    	    //n = IntDevices[new Random().nextInt(IntDevices.length)];      
	      			    	    //Istr.add(n);
		      			    	//addinNormal.add(n);
	      			    	 ...
	      			    	 else if (ss.equals("Boolean"))
	      			    	   {
	      			    		...
	      			    		//while (Bstr.contains(n))
	      			    			 //n = BoolDevices[new Random().nextInt(BoolDevices.length)];      
	      			    		//Bstr.add(n);
	      			    		jsonWriter.value(Loc2+"_"+n);
	      			    		...
	      			    		if (t.equals("B"))
		      			    	  {
		      			    	   ...
		      			    	   //while (Bstr.contains(n2))
		      			    		    //n2 = BoolDevices[new Random().nextInt(BoolDevices.length)];
		      			    	   //Bstr.add(n2);
	      			    		...
	      			    		else if (t.equals("I"))
	      			    		  {
		      			    	   ...
		      			    	   //while (Istr.contains(n2))
		      			    		    //n2 = IntDevices[new Random().nextInt(IntDevices.length)];      
		      			    	   //Istr.add(n2);
		      			    	   jsonWriter.value(Loc2+"_"+n2);
	      			    		  }
	      			    		jsonWriter.endObject();
		        	     ...
		        	     jsonWriter.name("actionGroup");
		      			 ...
		      			 jsonWriter.endArray();
	      			     jsonWriter.endObject();
	      			     //Istr = new HashSet<String>();
		        		 //Bstr = new HashSet<String>();
		                }
	        		 jsonWriter.endArray();
		      ...
		      /*for (int numpol = 1; numpol <= 10; numpol++)
		         {
		    	  try 
	    	        {
		    		 File sigPolicy = new File("/mnt/C486149D861491D2/PhD/New PhD/0000 Meetings/RVE_MS04/RVE/Policies/policy"+numpol+".json"); 
